package com.adobe.complexityanalyzer.core.servlets;
 ...
 * 
 * Endpoints:
 * - GET /bin/complexityanalyzer/page?path=/content/mysite/page
 *   Returns node count and complexity for a single page
 * 
 * - GET /bin/complexityanalyzer/pages?rootPath=/content/mysite&limit=100
 *   Returns node counts for all pages under rootPath
 * 
 * Example:
 * curl -u admin:admin "http://localhost:4502/bin/complexityanalyzer/page?path=/content/wknd/us/en"
 */
@Component(
    service = Servlet.class,
    property = {
        "sling.servlet.methods=GET",
        "sling.servlet.paths=/bin/complexityanalyzer/page",
